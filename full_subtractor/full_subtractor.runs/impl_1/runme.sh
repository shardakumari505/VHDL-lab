...
HD_PWD='D:/final year/8th sem/vhdl lab/full_subtractor/full_subtractor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log full_subtractor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source full_subtractor.tcl -notrace
