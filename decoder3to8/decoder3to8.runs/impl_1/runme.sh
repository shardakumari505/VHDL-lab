...
HD_PWD='D:/final year/8th sem/vhdl lab/decoder3to8/decoder3to8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log deco3x8_seq.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source deco3x8_seq.tcl -notrace
