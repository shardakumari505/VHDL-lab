...
HD_PWD='D:/final year/8th sem/vhdl lab/decoder3to8/decoder3to8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log deco3x8_seq.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source deco3x8_seq.tcl
