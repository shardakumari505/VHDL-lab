...
HD_PWD='D:/final year/8th sem/vhdl lab/up_counter/up_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log up_counter_sync.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source up_counter_sync.tcl -notrace
