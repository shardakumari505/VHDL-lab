...
HD_PWD='D:/final year/8th sem/vhdl lab/up_counter/up_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log up_counter_sync.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source up_counter_sync.tcl
