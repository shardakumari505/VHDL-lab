...
HD_PWD='D:/final year/8th sem/vhdl lab/encoder8to3/encoder8to3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log enco8x3_seq.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source enco8x3_seq.tcl
