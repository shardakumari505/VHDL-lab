...
HD_PWD='D:/final year/8th sem/vhdl lab/encoder8to3/encoder8to3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log enco8x3_seq.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source enco8x3_seq.tcl -notrace
