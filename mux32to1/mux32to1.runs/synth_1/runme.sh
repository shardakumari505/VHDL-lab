...
HD_PWD='D:/final year/8th sem/vhdl lab/mux32to1/mux32to1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux32to1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux32to1.tcl
