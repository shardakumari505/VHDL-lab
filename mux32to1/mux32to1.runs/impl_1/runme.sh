...
HD_PWD='D:/final year/8th sem/vhdl lab/mux32to1/mux32to1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux32to1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux32to1.tcl -notrace
