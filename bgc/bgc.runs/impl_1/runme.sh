...
HD_PWD='D:/final year/8th sem/vhdl lab/bgc/bgc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bgc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bgc.tcl -notrace
