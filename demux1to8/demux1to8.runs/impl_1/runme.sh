...
HD_PWD='D:/final year/8th sem/vhdl lab/demux1to8/demux1to8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log demux1to8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source demux1to8.tcl -notrace
