...
HD_PWD='D:/final year/8th sem/vhdl lab/not_gate/not_gate.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log not_gate.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source not_gate.tcl -notrace
