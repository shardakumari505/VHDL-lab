...
namespace eval ::optrace {
  variable script "D:/final year/8th sem/vhdl lab/siso/siso.runs/impl_1/siso.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir {D:/final year/8th sem/vhdl lab/siso/siso.cache/wt} [current_project]
  set_property parent.project_path {D:/final year/8th sem/vhdl lab/siso/siso.xpr} [current_project]
  set_property ip_output_repo {{D:/final year/8th sem/vhdl lab/siso/siso.cache/ip}} [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet {{D:/final year/8th sem/vhdl lab/siso/siso.runs/synth_1/siso.dcp}}
...
OPTRACE "Post-Place Phys Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force siso_physopt.dcp
...
OPTRACE "route_design reports" START { REPORT }
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -report_unconstrained -file siso_timing_summary_routed.rpt -pb siso_timing_summary_routed.pb -rpx siso_timing_summary_routed.rpx -warn_on_violation "
  ...
  create_report "impl_1_route_report_bus_skew_0" "report_bus_skew -warn_on_violation -file siso_bus_skew_routed.rpt -pb siso_bus_skew_routed.pb -rpx siso_bus_skew_routed.rpx"
