...
HD_PWD='D:/final year/8th sem/vhdl lab/demux32/demux32.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log demux32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source demux32.tcl
