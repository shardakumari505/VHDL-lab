...
HD_PWD='D:/final year/8th sem/vhdl lab/xnor_gate/xnor_gate.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log xnor_gate.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source xnor_gate.tcl -notrace
