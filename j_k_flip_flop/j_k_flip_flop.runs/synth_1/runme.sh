...
HD_PWD='D:/final year/8th sem/vhdl lab/j_k_flip_flop/j_k_flip_flop.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log j_k_flip_flop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source j_k_flip_flop.tcl
