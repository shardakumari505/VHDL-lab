...
HD_PWD='D:/final year/8th sem/vhdl lab/j_k_flip_flop/j_k_flip_flop.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log j_k_flip_flop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source j_k_flip_flop.tcl -notrace
