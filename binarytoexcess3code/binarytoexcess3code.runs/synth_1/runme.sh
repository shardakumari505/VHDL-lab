...
HD_PWD='D:/final year/8th sem/vhdl lab/binarytoexcess3code/binarytoexcess3code.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log binarytoexcess3code.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source binarytoexcess3code.tcl
