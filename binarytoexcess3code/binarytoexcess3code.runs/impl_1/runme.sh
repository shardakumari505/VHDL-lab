...
HD_PWD='D:/final year/8th sem/vhdl lab/binarytoexcess3code/binarytoexcess3code.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log binarytoexcess3code.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source binarytoexcess3code.tcl -notrace
