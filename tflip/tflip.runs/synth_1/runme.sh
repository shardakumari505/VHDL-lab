...
HD_PWD='D:/final year/8th sem/vhdl lab/tflip/tflip.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tflip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tflip.tcl
