...
HD_PWD='D:/final year/8th sem/vhdl lab/tflip/tflip.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tflip.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tflip.tcl -notrace
